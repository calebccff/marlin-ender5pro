...
#define STRING_CONFIG_H_AUTHOR "(caleb, Ender-5 Pro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Speedy Proonter"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -47, -14, -4.84 }
